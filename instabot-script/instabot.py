...
class Instabot:
    ...
    def user_followers(self, user):
        ...
        followers_list = []
        forbidden_followers = []
        forbidden_words = ['up', 'gy', 'gen', 'love', 'prir', 'onl', 'yt', 'nature', 'mk', 'devoj', 'shop', 'skop',
                           'rabo', 'pisatel', 'fitness', 'sport', 'memes', 'macedoni', 'shoe', 'prod', 'mod']
        is_forbidden = 0
...
bot = Instabot('elephant_1215', 'huijing1215')

# bot.user_followers('jenniferrrr.lin')
# print("main done")
